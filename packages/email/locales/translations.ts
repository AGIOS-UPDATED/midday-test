  ...
  switch (locale) {
    case "en":
      return {
        ...
        "invite.subject": `${params?.invitedByName} invited you to the ${params?.teamName} team on Updated`,
        "invite.preview": `Join ${params?.teamName} on Updated`,
        "invite.title1": "Join",
        "invite.title2": "on",
    ...
    case "sv":
      return {
        ...
        "invite.subject": `${params?.invitedByName} bjöd in dig till ${params?.teamName} på Updated`,
        "invite.preview": `Gå med i ${params?.teamName} på Updated`,
