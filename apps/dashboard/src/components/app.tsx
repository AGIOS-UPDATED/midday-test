        ...
        <SheetContent>
          ...
          <div className="absolute bottom-4 pt-8 border-t border-border">
            <p className="text-[10px] text-[#878787]">
              All apps on the Updated App Store are open-source and
              peer-reviewed. Updated Labs AB maintains high standards but doesn't
              endorse third-party apps. Apps published by Updated are officially
