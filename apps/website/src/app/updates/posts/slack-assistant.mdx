---
title: "Building the Updated Slack Assistant"
publishedAt: "2024-09-29"
summary: "This is a technical deep dive into how we built the Updated Slack Assistant using Vercel AI SDK, Trigger.dev and Supabase."
image: "/images/update/apps/slack.png"
tag: "Updates"
---

In this technical deep dive, we’ll explore how we built the Updated Slack Assistant by leveraging the Vercel AI SDK, Trigger.dev, and Supabase. Our goal was to create an AI-powered assistant that helps users gain financial insights, upload receipts, and manage invoices—all seamlessly from within their Slack workspace.

## Background
Updated already has an assistant available on both web and desktop via Electron, but we haven’t yet built a dedicated mobile app. As we continue iterating on our web app, we plan to eventually create a mobile version using Expo. In the meantime, we wanted to give our users a way to interact with Updated on the go. With that in mind, we turned to Slack, where users can quickly upload receipts and invoices without leaving the app they’re already using for work.
...
When users install our Slack app from the <a href="https://midday.ai/updates/apps">Apps section within Updated</a>, we obtain the necessary permissions to interact with the Slack API, send messages, and listen to events.
<br />
...
Updated is fully open-source, and you can find the pull request for the Slack Assistant and Apps <a href="https://github.com/midday-ai/midday/pull/262">here</a>.
<br/>
You can aslo try Updated for your own business by <a href="https://app.midday.ai">signing up here</a>.