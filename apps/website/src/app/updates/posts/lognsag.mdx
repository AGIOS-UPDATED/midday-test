...
share how we solved it in Updated using NextJS and server-actions.
...
<br />
The package includes all the events we want to track in Updated for example:
...
When you sign in to Updated we first ask you about tracking, we want you to keep your privacy. This is done by showing a `Toast` component with the option to Accept or Decline, we save this decision
