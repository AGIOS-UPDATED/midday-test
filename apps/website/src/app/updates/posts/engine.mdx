...
summary: "The core of Updated is based on our customers transactions. Using this data, we can do a lot to help you run your business smarter when it comes to financial insights, reconciling receipts, and more."
image: "/images/engine.png"
tag: "Updates"
---

The core of Updated is based on our customers transactions. Using this data, we can do a lot to help you run your business smarter when it comes to financial insights, reconciling receipts, and more.
...
We provide an API that gives our services transformed transactions, accounts, and balances for Updated to use. Here is how we built it and the technologies we chose.
...
<br />
Updated is fully open source. Feel free to check out our code [here](https://git.new/midday).
