...
summary: "Discover how we're implementing PDF invoice generation in Updated, using React-based solutions for customizable, efficient document creation."
...
<br />
We are building a new experience for invoices in Updated. You'll be able to create and send invoices to your customers, as well as generate PDFs for each invoice. 
